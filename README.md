...
## Синтаксис
В этом мини-языке на данный момент реализован Си-подобный синтаксис. Исполнение программы начинатеся с головной функции (в текущий реализации *main*) циклов (*while*) и условий (*if / else*), возможность объявления и использования своих функций и рекурсии. Есть встроенные функции языка для ввода / вывода (*in / out*). Поддерживается всего один ненулевой тип переменных - double (*var*).
