...
DIRECTORIES = -IFRONTEND -IBACKEND -IBACKEND/MC_BACKEND -IBACKEND/ELF_BACKEND -IEXTRA -IEXTRA/STACK -IEXAMPLES -IDSL -IBACKEND/ASM -IBACKEND/CPU -IBACKEND/DISASM -I/usr/include/c++/11
