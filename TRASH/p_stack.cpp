...
static void print_stack_data_double (pStructStack* stack) // print_el (int) // print_el(char) // print_el(double) //
{
    BGN;
...
static int make_stack_bigger (pStructStack* stack)
{
    ...
    stack->data = (pStackDataType*) realloc (stack->data, (stack->capacity > 0) ? stack->capacity * coef * sizeof (*stack->data) : (stack->capacity + 1) * coef * sizeof (*stack->data) );
...
static int make_stack_smaller (pStructStack* stack)
{
    BGN;
    ...
    stack->data = (pStackDataType*) realloc (stack->data, sizeof (*stack->data) * ( stack->capacity / coef));
    stack->capacity /= coef;
...
int stack_constructor (pStructStack* stack, int Capacity, const char* Name)
{
    ...
    stack->data = (pStackDataType*) calloc (1, stack->capacity * sizeof (*stack->data) + 2 * sizeof (CanaryType));

    //print_stack_data_double (stack);

    stack->source = (pStructInfo*) calloc (1, sizeof (*stack->source));
    stack->birth  = (pStructInfo*) calloc (1, sizeof (*stack->birth));
